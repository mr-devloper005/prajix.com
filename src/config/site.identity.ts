export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'prajix',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Prajix',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'prajix.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://prajix.com',
